...
**Статус** — управление сервисом, обновление ядра mihomo и самой панели, установка дашборда:

![Статус](docs/status.png)

**Конфигурация** — редактор `config.yaml` с проверкой, бэкапами и генератором прокси:
